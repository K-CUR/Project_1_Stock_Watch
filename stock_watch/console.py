...
fabric_2 = Fabric(manufacturer_1, "Nena02", "Blue", "Plain", 12.00, 16.00, 32)
fabric_repository.save(fabric_2)

fabric_3 = Fabric(manufacturer_1, "Nena03", "Grey", "Plain", 12.00, 16.00, 40)
fabric_repository.save(fabric_3)

fabric_4 = Fabric(manufacturer_2, "Satori08", "White", "Stripe", 16.00, 22.00, 22)
fabric_repository.save(fabric_4)

fabric_5 = Fabric(manufacturer_2, "Satori21", "Red", "Stripe", 16.00, 22.00, 33)
fabric_repository.save(fabric_5)

fabric_6 = Fabric(manufacturer_2, "Bella25", "Pink", "Floral", 18.00, 24.00, 50)
fabric_repository.save(fabric_6)

fabric_7 = Fabric(manufacturer_3, "Easter Bunny", "White", "Illustration", 8.00, 12.50, 0)
